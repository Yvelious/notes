...
symlink:
symlinkchapter: GIT
title: Resolving Conflicts in GIT by Taking All Changes from One Side
...
**N.B.**
The dot (`.`) at the end of the command means that the operation applies to all conflicting files. If you want to apply the command to a specific file, specify the path to that file instead of the dot.
