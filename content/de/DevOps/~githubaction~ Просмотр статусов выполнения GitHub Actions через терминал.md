...
Wähle die Art der Authentifizierung:
- GitHub.com
- HTTPS
...
Das Ergebnis wird in einem kompakten Format im Terminal angezeigt:
...
Ebenso kannst du nur die in der Warteschlange stehenden anzeigen:
```bash
...
Insgesamt erhalten wir eine automatisch aktualisierte Liste von GitHub Actions direkt im Terminal.

## Zusammenfassung

**Mit GitHub CLI und den Standard-Konsolenwerkzeugen kannst du:**
...
**Das ermöglicht eine viel schnellere und bequemere Arbeit mit CI, ohne ständig in den Browser wechseln zu müssen.**