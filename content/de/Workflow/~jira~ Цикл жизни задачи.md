...
Es gibt keinen allgemeinen Standard, der von allen Unternehmen akzeptiert wird. Jedes Unternehmen kann seinen eigenen Lebenszyklus einer Aufgabe definieren, der zu seinen Prozessen und Entwicklungsmethoden passt.

Im Folgenden ist ein Beispiel für den Lebenszyklus einer Aufgabe, den ich in meiner Arbeit verwende. Er ist nicht verbindlich und kann je nach den Bedürfnissen des Projekts geändert werden.
...
2. **To Do** - Die Aufgabe ist bereit zur Bearbeitung, ein Bearbeiter ist zugewiesen. Sie wartet auf ihre Bearbeitung.
...
Es gibt auch Zustände, die einer Aufgabe in jeder Phase ihres Lebenszyklus hinzugefügt werden können, unabhängig von ihrem aktuellen Zustand:
1. **Blocked** - Die Aufgabe ist blockiert und kann aus bestimmten Gründen nicht bearbeitet werden. Dies geschieht normalerweise, wenn die Ausführung der Aufgabe von einer anderen Aufgabe abhängt, die noch nicht abgeschlossen ist.
2. **On Hold** - Die Aufgabe ist pausiert. Zum Beispiel, wenn eine höherpriorisierte Aufgabe in Arbeit kommt.
