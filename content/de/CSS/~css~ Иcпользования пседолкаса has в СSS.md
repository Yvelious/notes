...
`:has()` ist ein **CSS-Selektor der neuen Generation**, der als _„Elternselektor“_ bezeichnet wird.  
...
**N.B.**
Selektoren mit `:has()` können **leistungsintensiv** sein, insbesondere wenn sie auf großen Seiten verwendet werden. Der Browser muss die **Innereien** jedes Elements durchsehen, um zu verstehen, ob der Stil angewendet werden soll.
